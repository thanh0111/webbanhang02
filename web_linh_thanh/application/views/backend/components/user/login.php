<html lang="">
    ...
    <body>
        <div class="container khung">
            <div class="title">
                <h2 class="text-center" style="color:#f46969ab">Linh Thanh Store</h2>
            </div>
            <hr>
            <div class="myform">
        ...
        <nav class="navbar navbar-fixed-bottom" role="navigation">
            <div class="container">
               <h5 class="text-center">Copyright © 2023 <a href="#" style="color:red">Linh Thanh Store</a>. All rights reserved.</h5>
            </div>
        </nav>
        <!-- jQuery -->
