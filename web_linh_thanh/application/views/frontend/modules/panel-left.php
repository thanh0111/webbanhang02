<div class="menu-pri">
    <div class="container">
        <div class="panel-left" style="background: #f46969ab;">
            <!--MOBILE-->
            <nav class="navbar navbar-default hidden-md hidden-lg" role="navigation">
                <div class="container-fluid" style="background-color: #f46969ab;">
        ...
        <div class="col-md-12 col-lg-12 panel-right hidden-xs text-center" style="background: #f46969ab;">
